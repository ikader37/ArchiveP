...
@NamedQueries({
    ...
    , @NamedQuery(name = "UserRoles.findByCreatedAt", query = "SELECT u FROM UserRoles u WHERE u.createdAt = :createdAt")
    , @NamedQuery(name = "UserRoles.findByUpdatedAt", query = "SELECT u FROM UserRoles u WHERE u.updatedAt = :updatedAt")})
public class UserRoles implements Serializable {
    ...
    public UserRoles(Integer id, int userId, int roleId) {
        this.id = id;
        this.userId = userId;
        this.roleId = roleId;
    }
    ...
    public String toString() {
        return "com.kader.archive.entities.UserRoles[ id=" + id + " ]";
    }
